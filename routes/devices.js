module.exports = function (driverManager, deviceManager) {
	...
	router.get('/', function(req, res, next) {
		res.render('devices', { title: 'Devices', deviceForms: driverManager.getDriversForms(), installedDrivers: driverManager.getInstalledDrivers(), devices: deviceManager.getDevices()});
	});
